...
androidComponents {
    onVariants { variant ->
        ...
        tasks.matching { task -> task.name == "assemble${variant.name.replaceFirstChar { it.uppercase() }}" }.configureEach {
...
dependencies {
    ...
    implementation("androidx.compose.material3.adaptive:adaptive-navigation3:1.3.0-alpha08")
