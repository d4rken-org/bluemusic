...
internal fun UpgradeOwnershipContent(
    ...
    UpgradeRestoreSection(
        title = stringResource(R.string.upgrade_screen_status_restore_title),
        body = stringResource(R.string.upgrade_screen_status_restore_body),
        onRestore = onRestore,
        busy = uiState.busy,
    )
}

// The "you have it" moment: a badge and congrats in one hero card at the top of the status
            ...
            Column(
                ...
                Text(
                    ...
                    text = stringResource(
                        ...
                        // Same brand the titles compose, through the same flavor title template.
                        brandTitleText(includeQualifier = true),
                    ),
                    style = MaterialTheme.typography.bodyMedium,
                )
