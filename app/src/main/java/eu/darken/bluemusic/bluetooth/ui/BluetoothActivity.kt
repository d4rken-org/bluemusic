...
import eu.darken.bluemusic.bluetooth.ui.discover.DiscoverFragment.Companion.newInstance
...
class BluetoothActivity : AppCompatActivity(), BluetoothActivityPresenter.View, HasManualFragmentInjector {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        builder<BluetoothActivityPresenter.View, BluetoothActivityPresenter>()
