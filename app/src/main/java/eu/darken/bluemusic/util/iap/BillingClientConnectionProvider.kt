...
class BillingClientConnectionProvider @Inject constructor(
    ...
    val connection: Observable<BillingClientConnection> = Observable.create<BillingClientConnection> { clientEmitter ->
        ...
        val client = newBuilder(context).apply {
            ...
            setListener { result, purchases ->
                if (result.isSuccess) {
                    Timber.d(
                        "onPurchasesUpdated(code=%d, message=%s, purchases=%s)",
                        result.responseCode,
                        result.debugMessage,
                        purchases
                    )
                    ...
                    Timber.w(
                        "error: onPurchasesUpdated(code=%d, message=%s, purchases=%s)",
                        result.responseCode,
                        result.debugMessage,
                        purchases
                    )
