...
import eu.darken.bluemusic.main.core.CurriculumVitae.ProTransition
...
class CurriculumVitaeProStateTest : BaseTest() {
    ...
    @Test
    fun `grace only engages coming from a confirmed purchase`() {
    ...
    @Test
    fun `pro is lost when a pro-ish state drops to free`() {
    ...
    @Test
    fun `recovering pro is never a counted transition`() {
    ...
    @Test
    fun `stored state parsing tolerates blank, corrupt and future values`() {
